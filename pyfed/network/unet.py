...
def _block(in_channels, features, name, affine=True, track_running_stats=True, norm='bn'):
    if norm == 'bn':
...
class UNetFedfa(nn.Module):
    def __init__(self, in_channels=3, out_channels=2, init_features=32,
                 affine=True, track_running_stats=True, aug_method=None, norm='bn'):
        ...
        self.encoder1 = _block(in_channels, features, name="enc1", affine=affine,
                               track_running_stats=track_running_stats, norm=norm)
